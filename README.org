...
| =SHARINGIO_PAIR_INIT_EXTRAS= |                                 | The manifests in the extra folder ([[./cluster-api/manifests/extra][cluster-api/manifests/extra]]) to apply when Environment is ready |
