...
server ${KUBERNETES_CONTROLPLANE_ENDPOINT} 53
zone ${SHARINGIO_PAIR_INSTANCE_SETUP_BASEDNSNAME}
update add ${SHARINGIO_PAIR_INSTANCE_SETUP_BASEDNSNAME}. 60 SOA ns1.${SHARINGIO_PAIR_INSTANCE_SETUP_BASEDNSNAME}. hostmaster.${SHARINGIO_PAIR_INSTANCE_SETUP_BASEDNSNAME}. 6 60 60 60 60
key pair ${POWERDNS_TSIG_SECRET}
send
EOF
    sleep 1s
